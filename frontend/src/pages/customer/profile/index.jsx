		...
		<MainLayout>
			<main className="w-[60%] mx-auto">
				...
				<section className="flex flex-col">
					...
					<button onClick={logout} className="border border-red-500 text-red-500 flex gap-[11px] items-center rounded-full py-[10px] px-8 mt-3 self-end duration-100 hover:bg-red-500 hover:text-white">
						Logout
					</button>
				</section>
			</main>
