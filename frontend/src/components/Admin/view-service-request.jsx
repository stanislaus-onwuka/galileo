                ...
                <div className="w-full max-w-[600px] rounded-2xl bg-white">
                    <div className="max-w-2xl mx-auto bg-white p-6 rounded-lg shadow-md">
                        ...
                        <div className="flex justify-end space-x-4">
                            <button onClick={() => setShowModal(false)} className="bg-gray-200 text-gray-700 px-4 py-2 rounded-md">Cancel</button>
                            <button className="bg-gray-500 text-white px-4 py-2 rounded-md" disabled>
                                Contact Artisan
                            </button>
                            <button className="bg-default text-white px-4 py-2 rounded-md">
                                Process Payment
                            </button>
                        </div>
                    </div>
